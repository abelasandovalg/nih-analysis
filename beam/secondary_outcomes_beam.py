...
def run():
     ...
     # sql code 
     sql = 'SELECT nct_number, measure, time_frame, safety_issue, description, serialid FROM nih_modeled.secondary_outcomes limit 10'
     ...
     table_id = 'secondary_outcomes_Beam'
