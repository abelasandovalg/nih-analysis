...
def run():
     ...
     google_cloud_options.job_name = 'secondary-outcomes-df'
     ...
     # sql code 
     sql = 'SELECT nct_number, measure, time_frame, safety_issue, description, serialid FROM nih_modeled.primary_outcomes'
     ...
     table_id = 'secondary_outcomes_Beam_DF'
