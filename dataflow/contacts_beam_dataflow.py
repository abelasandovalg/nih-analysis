...
def run():
     ...
     google_cloud_options.job_name = 'contacts-df'
     ...
     # sql code 
     sql = 'SELECT nct_number, last_name, phone, phone_ext, email, serialid FROM nih_modeled.contacts'
