...
def run():
     ...
     google_cloud_options.job_name = 'responsible-parties-df'
     ...
     # sql code 
     sql = 'SELECT nct_number, name_title, organization, type, investigator_affiliation, investigator_full_name, investigator_title, serialid FROM nih_modeled.responsible_parties'
     ...
     table_id = 'responsible_parties_Beam_DF'
