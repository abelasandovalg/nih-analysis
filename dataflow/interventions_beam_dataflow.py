...
class ExtractNCTDoFn(beam.DoFn):
  ...
  def process(self, element):
     ...
     intervention_type = nih_record.get('intervention_type')
     intervention_name = nih_record.get('intervention_name')
...
def run():
     ...
     google_cloud_options.job_name = 'interventions-df'
     ...
     # sql code 
     sql = 'SELECT nct_number, intervention_type, intervention_name, arm_group_label, serialid FROM nih_modeled.interventions'
     ...
     table_id = 'interventions_Beam_DF'
     schema_id = 'nct_number:STRING, intervention_type:STRING, intervention_name:STRING, arm_group_label:STRING, serialid:INTEGER'
