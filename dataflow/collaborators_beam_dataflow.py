...
class ExtractNCTDoFn(beam.DoFn):
  ...
  def process(self, element):
     ...
     collaborator_agency = nih_record.get('collaborator_agency')
     collaborator_agency_class = nih_record.get('collaborator_agency_class')
...
def run():
     ...
     google_cloud_options.job_name = 'collaborators-df'
     ...
     # sql code 
     sql = 'SELECT nct_number, collaborator_agency, collaborator_agency_class, serialid FROM nih_modeled.collaborators'
     ...
     table_id = 'collaborators_Beam_DF'
     schema_id = 'nct_number:STRING, collaborator_agency:STRING, collaborator_agency_class:STRING, serialid:INTEGER'
