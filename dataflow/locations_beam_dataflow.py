...
def run():
     ...
     google_cloud_options.job_name = 'locations-df'
     ...
     # sql code 
     sql = 'SELECT nct_number, facility_name, facility_city, facility_state, facility_zip, facility_country, serialid FROM nih_modeled.locations'
