...
def run():
     ...
     google_cloud_options.job_name = 'clinical-results-df'
     ...
     # sql code 
     sql = 'SELECT nct_number, type, title, time_frame, safety_issue, results_population, serialid FROM nih_modeled.clinical_results'
     ...
     table_id = 'clinical_results_Beam_DF'
